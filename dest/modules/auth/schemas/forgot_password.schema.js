...
class NewPasswordSchema {
    constructor() {
        this.forgotPassword = joi_1.default.object({
        ...
        this.forgotPasswordVerify = joi_1.default.object({
            otp: joi_1.default.string().trim().required(),
            token: joi_1.default.string().trim().required(),
        });
        this.resetPassword = joi_1.default.object({
...
exports.default = new NewPasswordSchema();
